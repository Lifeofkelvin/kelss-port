...
const emailSpace = document.querySelector(".email");
const inputSpace = document.querySelectorAll(".form-inp");
...
if (localStorage.getItem("darkMode") === "true") {
  ...
  emailSpace.classList.add("dark-mode");
  submitBtn.classList.add("dark-mode");
  textSpace.classList.add("dark-mode");
...
https: switchButton.addEventListener("change", () => {
  if (switchButton.checked) {
    ...
    emailSpace.classList.remove("dark-mode");
    profilePic.classList.remove("dark-mode");
    submitBtn.classList.remove("dark-mode");
    textSpace.classList.remove("dark-mode");
    navLink.forEach((link) => {
